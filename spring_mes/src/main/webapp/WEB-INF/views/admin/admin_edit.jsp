...
<div class="form-container">
  ...
  <form id="editForm">
    ...
    <div class="form-group">
      <label>로그인 ID</label>
      <p style="margin:0; color:var(--text);">${user.loginId}</p>
    </div>
    ...
    <div class="form-group">
      ...
      <select name="role" id="role">
        ...
        <option value="WORKER" <c:if test="${user.role eq 'WORKER'}">selected</c:if>>WORKER</option>
      </select>
    </div>
...
function submitEdit() {
  ...
  fetch("${pageContext.request.contextPath}/admin/userEdit", {
    method: "POST",
